import { DB_TABLES, validateFieldType, FIELD_TYPES } from "../types/database";
import { Pool } from "pg";
...
export interface UpdateCaseParams extends ToolParams {
  id: number;
  name: string;
  description: string;
  model: WorkflowModel;
...
export interface CreateFieldParams extends ToolParams {
  name: string;
  type: string;
  caseID: number;
  primary?: boolean;
...
export interface CreateViewParams extends ToolParams {
  name: string;
  caseID: number;
  model: ViewModel;
  stepName: string;
...
export function getDatabaseTools(pool: Pool) {
  return [
    ...
    },
    {
      ...
      execute: async (params: UpdateCaseParams) => {
    ...
    },
    {
      ...
      execute: async (params: CreateFieldParams) => {
        // Validate field type
    ...
    },
    {
      ...
      execute: async (params: CreateViewParams) => {
